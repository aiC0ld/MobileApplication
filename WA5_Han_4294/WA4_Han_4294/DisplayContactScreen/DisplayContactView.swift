...
class DisplayContactView: UIView {
    ...
    func initConstraints() {
        NSLayoutConstraint.activate([
            ...
            imagePhoto.topAnchor.constraint(equalTo: self.safeAreaLayoutGuide.topAnchor, constant: 32),
            ...
            nameLabel.topAnchor.constraint(equalTo: imagePhoto.bottomAnchor, constant: 32),
